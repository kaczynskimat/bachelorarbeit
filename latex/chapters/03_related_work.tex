...
While these approaches demonstrate a clear trend in the literature toward shifting the "privacy workload" from the Cloud to the Edge and Fog, most existing studies focus primarily on optimizing the algorithms themselves or designing secure communication protocols. There remains a lack of systematic analysis regarding the placement of specific preprocessing steps---such as prefiltering, generalization, or temporal aggregation---within a multi-layered architecture. Specifically, the trade-offs between privacy guarantees, information loss, and system performance when shifting these tasks across different layers remain underexplored in the context of high-frequency smart metering.
